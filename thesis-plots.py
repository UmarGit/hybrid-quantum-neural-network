...
ax.set_title(
    "Figure X - Swiss Roll (19-Seed): Topological Advantage",
    fontsize=TITLE_SIZE,
    fontweight="bold",
)
ax.set_xticks(x)
...
ax2.set_title(
    "Figure Y - The Execution Time Bottleneck (IBM Torino Simulation)",
    fontsize=TITLE_SIZE,
    fontweight="bold",
)
ax2.set_xticks(x2)
...
# Leukemia
bplot1 = ax3a.boxplot(
    [classical_leukemia, quantum_leukemia],
    patch_artist=True,
    labels=["Classical ResNet", "Hybrid ResQNet"],
)
...
fig3.suptitle(
    "Figure Z - 20-Seed Robustness Distribution: Representational Parity",
    fontsize=TITLE_SIZE,
    fontweight="bold",
)
plt.tight_layout()
